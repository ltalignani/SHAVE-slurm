...
echo -e "${green}-----------------${nc}"
echo ""
echo -e "${blue}Name${nc} __________________ Start_vcf_hf.sh"
...
echo -e "${blue}Run${nc} ___________________ bash Start_vcf_hf.sh"
...
snakemake \
    --directory ${workdir}/ \
    --snakefile workflow/rules/shave_vcf_hf.smk \
    --config os=${os} \
    --rerun-incomplete \
    --unlock \
    --use-conda \
