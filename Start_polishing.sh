...
###Charge module
module purge
module load samtools/1.15.1 snakemake/7.7.0 slurm-drmaa/1.0.8 gatk4/4.2.6.1 java-jdk/8.0.112 picard/2.23.5 multiqc/1.13 qualimap/2.2.2b graphviz/2.40.1
...
snakemake \
    --directory ${workdir}/ \
    --snakefile workflow/rules/shave_polishing.smk \
    --config os=${os} \
    --rerun-incomplete \
    --unlock \
    --use-conda \
